				...
				{DOT_INDEXES.map((i) => {
					...
					return (
						<circle
							...
							cy={2 + row * 4}
							r={1.3}
							className="[transition-property:--aui-dot-matrix-hi,--aui-dot-matrix-lo,opacity] duration-300 [animation-iteration-count:infinite] [animation-name:aui-dot-matrix-blink] [animation-timing-function:ease-in-out]"
							style={
								{
									opacity: hi,
